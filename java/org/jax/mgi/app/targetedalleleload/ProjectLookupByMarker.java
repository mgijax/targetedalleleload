...
public class ProjectLookupByMarker extends FullCachedLookup {
	 ...
	 */
	public ProjectLookupByMarker(Integer logicalDb) throws ConfigException,
	 ...
	 *             thrown if there is an error accessing the configuration
	 */
	public HashSet lookup(String projectID) throws DBException, CacheException {
	 ...
	 *             thrown if there is an error accessing the configuration
	 */
	public HashSet lookupExisting(String projectID) throws DBException,
	...
	public String getFullInitQuery() {
		return "SELECT distinct m.symbol 'symbol', a1.accID 'projectid' "
				...
				+ "AND allele._marker_key = m._marker_key " + "ORDER BY symbol";
	}
	 ...
	 * @param symbol
	 *            marker symbol that the projects are associated with
	 * @param projectSet
	 *            project IDs associated to this marker
	 * @throws DBException
