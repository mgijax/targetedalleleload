...
/**
 * @is An abstract object that knows how to read clone records from an input
 *     file. Each input file must have a class that overrides this method and
 *     provides specific handling for that file.
 * @has <UL>
