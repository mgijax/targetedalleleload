...
public class MarkerLookup extends FullCachedLookup
{
    ...
    /**
     * look up an associated marker to a given MGI ID.  The Marker MUST exist
     * or the allele will not be loaded, throw an exception if the marker
     * doesn't exist
     * @param mgiid the primary MGI ID of the marker
     ...
     * mouse markers annotated to MGI ID
     * @return the initialization query
     */
    public String getFullInitQuery()
    {
        return
            "select mgiid = a2.accID, markerKey = a2._Object_key, " +
