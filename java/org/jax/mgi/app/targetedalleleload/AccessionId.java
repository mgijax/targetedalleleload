...
public class AccessionId {
	 ...
	 * 
	 * @param logicalDb
	 *            the logical database of the accession ID
	 * @param objectKey
	 ...
	 */
	public AccessionId(int logicalDb, int objectKey, int mgiTypeKey,
			Boolean privateVal, Boolean preferred) {
	...
	/**
	 * Insert this AccessionId object into the stream to create the required bcp
	 * records.
	 * 
	...
	public String toString() {
		return "<AccessionID: " + this.accessionId + " (key: " + this.getKey()
				+ ")>";
	}
